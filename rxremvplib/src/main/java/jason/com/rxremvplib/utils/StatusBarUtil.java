...
//https://github.com/aqi00/note/blob/master/ExmRefressh
public class StatusBarUtil {
    ...
    public static void fullScreen(Activity activity) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            setStatusBarColor(activity, activity.getResources().getColor(R.color.color_basic));
        }
    }
